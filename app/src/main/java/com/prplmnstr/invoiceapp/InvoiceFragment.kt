    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.logoutImage.setOnClickListener { view ->
            ...
            popupMenu.setOnMenuItemClickListener { menuItem ->
                ...
                invoiceViewModel.sharedPreferencesManager.clearUserData()
                findNavController().navigate(R.id.action_invoiceFragment_to_welcomeFragment)
                true
            }
        }

        invoiceViewModel.getInvoiceNumber()
        invoiceViewModel.message.observe(viewLifecycleOwner, Observer {
